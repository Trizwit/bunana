...
function Hero(){
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Discover some of the BEST Creators here at BunanA.</h1>
      ...
      <div className="p-2 lg:w-full md:w-full">
        ...
        <div className=" grid grid-cols-3 gap-6 divide-x divide-[#2EADC5]">
         <div className="flex justify-center flex-col w-52 ">
          <h2 className="flex  justify-center text-2xl text-[#f8fafc] font-semibold">Creators</h2>
          ...
          <h2 className="flex  justify-center text-2xl text-[#f8fafc] font-semibold ">Contents</h2>
        
             <p className="flex  justify-center text-[#f8fafc] text-5xl font-semibold  py-16">40k+</p>         
    </div>
          <div className="flex justify-center flex-col ">
          <h2 className="flex  justify-center text-2xl text-[#f8fafc] font-semibold">Users</h2>
        
        <p className="flex  justify-center text-[#f8fafc] text-5xl font-semibold  py-16">1M+</p>
          </div>
         </div>
