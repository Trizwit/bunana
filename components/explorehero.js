    ...
    <div className="container w-full h-48 bg-transparent sticky top-0 z-50 ">
      <div className="grid grid-row-2 gap-4  bg-[#152022] sticky">
        ...
        <div className="mx-8 mt-12  h-24 rounded-t-[12px] bg-gradient-to-b from-[#2EADC5] to-[#2EADC500]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-2 lg:gap-2 mt-4 bg-[#152022]">
            <a href="#">
